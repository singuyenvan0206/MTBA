                        ...
                        <div className="movie-card" key={movie.id}>
                            <div className="movie-poster">
                                ...
                                <div className="movie-overlay">
                                    <Link href={`/pos2/movies/${movie.id}`} className="btn btn-primary" style={{ marginBottom: '10px', width: '80%', textAlign: 'center' }}>Mua vé</Link>
                                    <Link href={`/pos2/movies/${movie.id}`} className="btn btn-outline" style={{ width: '80%', textAlign: 'center' }}>Chi tiết</Link>
                                </div>
                            </div>
